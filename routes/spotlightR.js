...
const spotlightC = require("../controllers/spotlightC");
const multer = require("multer");



const storage = multer.diskStorage({
    destination: "public/uploads/spotlights",
...
// alumni page
router.get("/alumni", spotlightC.alumnispotlightPage);


// student page
router.get("/student", spotlightC.studentspotlightPage);

router.get("/mentor", spotlightC.mentorspotlightPage);
...
router.post(
    "/post",
    upload.single("file"),
    spotlightC.postspotlight
);


router.get(
    "/delete/:id",
    spotlightC.deletespotlight
);
